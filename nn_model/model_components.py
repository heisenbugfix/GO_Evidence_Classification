# borrowed from https://github.com/ematvey/hierarchical-attention-networks/model_components.py
...
# a = np.asarray([[[1,2,3],[4,5,6]], [[2,6,9],[5,2,1]],[[5,8,9],[5,9,1]]])
# b = tf.get_variable(name="ash",shape=[3,2,3])
# output_size = 5
# d = task_specific_attention(b, output_size)
# print("OK")