...
OUTPUT_FILE = "new_pubmed_output.txt"
with open('../data/new_references.pkl','rb') as f:
    ref_id=pkl.load(f)
...
parse_pubmed('/home/ttanna/GO_Evidence_Classification/local/ftp.ncbi.nlm.nih.gov/pubmed/baseline')
